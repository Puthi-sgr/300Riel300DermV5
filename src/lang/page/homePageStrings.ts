...
export const homepageStrings: StringsByLanguage = {
  en: {
    // Navigation
    "nav.home": "Home",
    "nav.about": "About Us",
  ...
  km: {
    ...
    "project.highlights.tagline":
      "ស្ដារ​ដើមកោងកាង ជាដំណាក់កាល ម្ចាស់ជំនួយ 300 រៀល ម្តងៗ",
    "project.highlights.body1":
    ...
    "project.gallery.description":
      "មើលខ្លឹមសារថ្ងៃដាំដើម ឬជំនួសជារូបភាពផ្ទាល់ខ្លួនរបស់អ្នក។",
    ...
    "project.sponsors.subtitle":
      "សូមអរគុណដល់ដៃគូដែលបានធ្វើឲ្យបេសកកម្មនេះអាចប្រព្រឹត្តបាន",
    "project.sponsors.bus": "បរិច្ចាគរថយន្តក្រុមហ៊ុន (ប្រហាក់ប្រហែល USD 350)",
    "project.sponsors.meals":
      "ផ្ដល់អាហារ និងកន្លែងស្នាក់នៅ (ប្រហាក់ប្រហែល USD 260)",
