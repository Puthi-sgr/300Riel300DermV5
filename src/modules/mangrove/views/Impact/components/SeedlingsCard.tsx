...
export const SeedlingsCard = ({ data }: { data: ImpactCardProps }) => (
  <article className="relative overflow-hidden rounded-3xl p-6 sm:p-7 glass-card bg-card-glass text-earth-900 shadow-impact border border-white/70 lg:row-span-2 flex flex-col">
