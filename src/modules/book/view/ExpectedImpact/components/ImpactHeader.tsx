...
const ImpactHeader: React.FC<ImpactHeaderProps> = ({ title, subtitle }) => {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <PillBadge className="bg-pill-eco text-eco-700 border-eco-200">{t("book.expectedImpact.badge")}</PillBadge>
      </div>
