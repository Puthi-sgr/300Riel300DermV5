...
const WhyUsLayout: React.FC<WhyUsLayoutProps> = ({ title, kicker, description, children }) => (
  <section className="relative overflow-hidden bg-gradient-to-br from-[#f6fbf7] via-white to-[#eef6ee] px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
    <div className="absolute inset-0 pointer-events-none">
      <BackgroundBlob className="-top-24 -left-12 w-72 h-72" />
      <BackgroundBlob className="-bottom-24 right-0 w-72 h-72" colorClass="bg-eco-200/24" />
    </div>
    <motion.div
