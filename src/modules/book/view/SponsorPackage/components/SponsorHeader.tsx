...
const SponsorHeader: React.FC<SponsorHeaderProps> = ({ title, subtitle }) => {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <PillBadge className="bg-pill-eco text-eco-700 border-eco-200">{t("book.sponsorPackage.badge")}</PillBadge>
      </div>
