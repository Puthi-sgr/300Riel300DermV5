...
const ImpactStrip = lazy(() => import("./views/ImpactStrip/index"));    

const Sponsors = lazy(() => import("./views/Sponsors/index"));
const FeaturedProjects = lazy(() => import("./views/FeaturedProject/index"));
const About = lazy(() => import("./views/About/index"));
const Gallery = lazy(() => import("./views/Gallery/index"));
const Donate = lazy(() => import("./views/Donate/index"));
